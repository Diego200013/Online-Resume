...
var HTMLskillsStart = '<h3 id="skills-h3">Skills:</h3><ul id="skills" class="flex-item"></ul>';
var HTMLskills = '<li class="flex-item skillsOrientation"><span class="white-text">%data%</span></li>';
